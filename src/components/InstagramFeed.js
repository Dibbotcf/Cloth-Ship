...
const posts = [
  ...
  { id: 2, image: '/images/categories/men.webp' },
  { id: 3, image: '/images/products/kurta-blue.png' },
  { id: 4, image: '/images/brand/story.webp' },
      ...
      <div className={styles.grid}>
        {posts.map(post => (
          <a key={post.id} href={FB_URL} target="_blank" rel="noopener noreferrer" className={styles.post}>
            <img src={post.image} alt="Cloth Ship Facebook" className={styles.postImage} loading="lazy" decoding="async" />
