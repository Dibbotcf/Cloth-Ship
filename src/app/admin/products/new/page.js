      ...
      <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
          ...
          <div className={styles.imageUploadArea}>
            ...
            <div className={styles.imageUploadControls}>
              ...
              <button type="button" onClick={() => fileRef.current.click()} className={styles.primaryBtn} disabled={uploading} style={{ width: 'fit-content' }}>
                {uploading ? '⏳ Uploading…' : <><FolderOpen size={18} style={{ display: 'inline', verticalAlign: 'text-bottom', marginRight: '6px' }} />Choose Image</>}
              </button>
              <span className={styles.fieldHint}>Supports JPG, PNG, WEBP · Uploaded to /images/products/</span>
              <div className={styles.field}>
                <label className={styles.fieldLabel}>Or paste Image URL / Path</label>
                <input
        ...
        <div className={styles.formGrid3} style={{ marginBottom: 20 }}>
          <div className={styles.field}>
            ...
            <input type="text" name="name" required value={formData.name} onChange={handleChange} className={styles.fieldInput} placeholder="e.g. Royal Silk Saree" />
          </div>
          <div className={styles.field}>
            <label className={styles.fieldLabel}>Price (৳) <span className={styles.fieldRequired}>*</span></label>
            <input type="number" name="price" required min="0" value={formData.price} onChange={handleChange} className={styles.fieldInput} placeholder="8500" />
          </div>
          <div className={styles.field}>
            <label className={styles.fieldLabel}>Original Price (৳)</label>
            <input type="number" name="original_price" min="0" value={formData.original_price} onChange={handleChange} className={styles.fieldInput} placeholder="12000 (for discount)" />
          </div>
        </div>
        ...
        <div className={styles.field} style={{ marginBottom: 20 }}>
          ...
          <input type="text" name="sizes" required value={formData.sizes} onChange={handleChange} className={styles.fieldInput} placeholder="S, M, L, XL, XXL" />
          <span className={styles.fieldHint}>Comma-separated list of available sizes</span>
        </div>
        ...
        <div className={styles.field} style={{ marginBottom: 20 }}>
          ...
          <textarea name="story" rows="4" value={formData.story} onChange={handleChange} className={styles.fieldTextarea} placeholder="Handwoven by master artisans from Rajshahi, this saree takes over 15 days to complete. Each motif tells a story of Bengali heritage..." />
        </div>
        ...
        <div className={styles.field} style={{ marginBottom: 28 }}>
          ...
          <textarea name="material" rows="4" value={formData.material} onChange={handleChange} className={styles.fieldTextarea} placeholder="100% Pure Silk. Dry clean only. Do not bleach. Iron on low heat. Store in a cool, dry place..." />
        </div>
        ...
        <div className={styles.formActions}>
          <button type="submit" disabled={loading || uploading} className={styles.primaryBtn}>
            {loading ? '⏳ Saving…' : <><Check size={18} style={{ display: 'inline', verticalAlign: 'text-bottom', marginRight: '6px' }} />Save Product</>}
          </button>
      ...
      <div style={{
        ...
        {stockLoading ? (
          ...
          <div style={{ padding: '24px', textAlign: 'center', color: '#a0a0a0', fontSize: 13 }}>
            No products yet. This will be the first!
          </div>
        ) : (
